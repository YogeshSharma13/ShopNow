    ...
    return (
      ...
      />
        ...
        <Routes>
          ...
          <Route exact path="/myOrders" element={<UserOrders header={Navbar}/>} />
          <Route exact path="/userDash" element={<UserDashboard header={Navbar}/>} />
          <Route exact path="/about" element={<About header={Navbar}/>} />
          <Route exact path="/contact" element={<Contact header={Navbar}/>} />
